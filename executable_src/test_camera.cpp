...
int main(){
    ...
    Plane* plane1 = new Plane(Vector3f(0,-3,0), Vector3f(0,0,1), Vector3f(1,0,0), new PureTexture(Vector3f(0, 0.5, 0)));
    plane1->geometry = geometry;
    ...
    Observer4* observer = new HorizontalObserver4(Vector4f(0, 10, 0, 0), Vector4f(1, 0, 0.0001, 0), geometry, space_direction);
    observer->correction();
    ...
    Camera4* camera = new Camera4(200, 300, 1.6, observer, perspective);
